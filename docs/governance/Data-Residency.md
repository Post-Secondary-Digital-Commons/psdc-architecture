...
This specification defines **Data Residency** as part of the Post Secondary Digital
...
- The Data Residency capability SHALL provide accountable decision rights, repository control, safety, audit, contribution, and institution participation.
