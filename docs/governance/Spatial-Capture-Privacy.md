...
This specification defines **Spatial Capture Privacy** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Spatial Capture Privacy.
...
- The Spatial Capture Privacy capability SHALL provide accountable decision rights, repository control, safety, audit, contribution, and institution participation.
