...
This specification defines **Open Source License Compliance** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Open Source License Compliance.
...
- The Open Source License Compliance capability SHALL provide accountable decision rights, repository control, safety, audit, contribution, and institution participation.
