...
This specification defines **Third Party Provider Policy** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Third Party Provider Policy.
...
- The Third Party Provider Policy capability SHALL provide accountable decision rights, repository control, safety, audit, contribution, and institution participation.
