...
This specification defines **Infrastructure as Code** as part of the Post Secondary Digital
...
- The Infrastructure as Code capability SHALL provide self-hosted service catalog, provisioning, placement, quota, metering, and lifecycle control across replaceable infrastructure.
