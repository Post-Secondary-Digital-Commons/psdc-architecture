...
This specification defines **Service Catalog** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Service Catalog.
...
- The Service Catalog capability SHALL provide self-hosted service catalog, provisioning, placement, quota, metering, and lifecycle control across replaceable infrastructure.
