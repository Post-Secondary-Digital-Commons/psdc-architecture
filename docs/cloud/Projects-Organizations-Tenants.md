...
> Domain: cloud
> Owner: PSDC Cloud Working Group; accountable maintainer RedjiJB until delegation
> Last reviewed: 2026-09-11

## Purpose and outcome

This specification defines **Projects Organizations Tenants** as part of the Post Secondary Digital
Commons. Its required outcome is self-hosted service catalog, provisioning, placement, quota, metering, and lifecycle control across replaceable infrastructure. An implementation conforms
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Projects Organizations Tenants.
...
- The Projects Organizations Tenants capability SHALL provide self-hosted service catalog, provisioning, placement, quota, metering, and lifecycle control across replaceable infrastructure.
...
- Required interoperability boundary: service catalog, tenant, quota, provisioning, placement, usage, lifecycle, and provider-adapter contracts.
...
- Governed information includes desired state, resource inventory, quotas, leases, placement decisions, usage records, and provider reconciliation state.
...
- Domain controls SHALL include tenant isolation, policy-controlled provisioning, short-lived workload identity, secret separation, and audited privileged operations.
...
- Required lifecycle behaviour includes declarative reconciliation, idempotent provisioning, drift detection, quota enforcement, rollback, and provider outage isolation.
...
- Adopted boundary and strategy: OpenTofu, Kubernetes, Helm, GitOps, OpenStack and other providers through optional open adapters.
...
- Commons Cloud composes mature cloud, container, storage, identity, and observability systems rather than reimplementing them.
