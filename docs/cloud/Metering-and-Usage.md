...
This specification defines **Metering and Usage** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Metering and Usage.
...
- The Metering and Usage capability SHALL provide self-hosted service catalog, provisioning, placement, quota, metering, and lifecycle control across replaceable infrastructure.
