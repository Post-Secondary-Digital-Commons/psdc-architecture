...
This specification defines **Hybrid Cloud Broker** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Hybrid Cloud Broker.
...
- The Hybrid Cloud Broker capability SHALL provide self-hosted service catalog, provisioning, placement, quota, metering, and lifecycle control across replaceable infrastructure.
