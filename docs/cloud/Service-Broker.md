...
This specification defines **Service Broker** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Service Broker.
...
- The Service Broker capability SHALL provide self-hosted service catalog, provisioning, placement, quota, metering, and lifecycle control across replaceable infrastructure.
