...
This specification defines **OpenTofu Standards** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for OpenTofu Standards.
...
- The OpenTofu Standards capability SHALL provide reproducible environment promotion from local development through staging and production.
