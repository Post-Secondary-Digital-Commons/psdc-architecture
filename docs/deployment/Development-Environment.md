...
This specification defines **Development Environment** as part of the Post Secondary Digital
...
- The Development Environment capability SHALL provide reproducible environment promotion from local development through staging and production.
