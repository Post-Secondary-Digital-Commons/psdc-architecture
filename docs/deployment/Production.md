...
This specification defines **Production** as part of the Post Secondary Digital
...
- The Production capability SHALL provide reproducible environment promotion from local development through staging and production.
