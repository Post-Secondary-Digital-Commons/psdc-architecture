...
This specification defines **Local Development** as part of the Post Secondary Digital
...
- The Local Development capability SHALL provide reproducible environment promotion from local development through staging and production.
