...
This specification defines **Staging** as part of the Post Secondary Digital
...
- The Staging capability SHALL provide reproducible environment promotion from local development through staging and production.
