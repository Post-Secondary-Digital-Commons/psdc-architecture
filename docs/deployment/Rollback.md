...
This specification defines **Rollback** as part of the Post Secondary Digital
...
- The Rollback capability SHALL provide reproducible environment promotion from local development through staging and production.
