...
This specification defines **Environment Strategy** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Environment Strategy.
...
- The Environment Strategy capability SHALL provide reproducible environment promotion from local development through staging and production.
