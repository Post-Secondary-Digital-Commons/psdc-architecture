...
This specification defines **Helm and Kubernetes** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Helm and Kubernetes.
...
- The Helm and Kubernetes capability SHALL provide a portable developer platform with consistent APIs, SDKs, builds, registries, templates, and environments.
