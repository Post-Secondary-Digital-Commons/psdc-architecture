...
This specification defines **Public API Standards** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Public API Standards.
...
- The Public API Standards capability SHALL provide a portable developer platform with consistent APIs, SDKs, builds, registries, templates, and environments.
