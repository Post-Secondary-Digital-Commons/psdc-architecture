...
This specification defines **TypeScript SDK** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for TypeScript SDK.
...
- The TypeScript SDK capability SHALL provide a portable developer platform with consistent APIs, SDKs, builds, registries, templates, and environments.
