...
This specification defines **Templates** as part of the Post Secondary Digital
...
- The Templates capability SHALL provide a portable developer platform with consistent APIs, SDKs, builds, registries, templates, and environments.
