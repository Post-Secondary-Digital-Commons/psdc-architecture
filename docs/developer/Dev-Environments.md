...
This specification defines **Dev Environments** as part of the Post Secondary Digital
...
- The Dev Environments capability SHALL provide a portable developer platform with consistent APIs, SDKs, builds, registries, templates, and environments.
