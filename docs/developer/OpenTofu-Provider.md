...
> Domain: developer
> Owner: PSDC Developer Working Group; accountable maintainer RedjiJB until delegation
> Last reviewed: 2026-09-11

## Purpose and outcome

This specification defines **OpenTofu Provider and Module Interface** as part of the Post Secondary Digital
Commons. Its required outcome is a portable developer platform with consistent APIs, SDKs, builds, registries, templates, and environments. An implementation conforms
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for OpenTofu Provider and Module Interface.
...
- The OpenTofu Provider and Module Interface capability SHALL provide a portable developer platform with consistent APIs, SDKs, builds, registries, templates, and environments.
...
- Required interoperability boundary: OpenAPI, AsyncAPI, generated SDK boundaries, OCI registries, CLI contracts, templates, and build metadata.
...
- Governed information includes source metadata, schemas, artifacts, SBOMs, provenance, test results, package indexes, and developer environment state.
...
- Domain controls SHALL include least-privilege build identities, untrusted pull-request isolation, dependency pinning, secret scanning, signing, and provenance verification.
...
- Required lifecycle behaviour includes repeatable builds, cache isolation, compatibility testing, deprecation windows, artifact retention, and reproducible local environments.
...
- Adopted boundary and strategy: Git, OCI, SPDX or CycloneDX SBOMs, SLSA-compatible provenance, OpenAPI, AsyncAPI, and language-native package standards.
