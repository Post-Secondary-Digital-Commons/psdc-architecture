...
This specification defines **GitOps** as part of the Post Secondary Digital
...
- The GitOps capability SHALL provide a portable developer platform with consistent APIs, SDKs, builds, registries, templates, and environments.
