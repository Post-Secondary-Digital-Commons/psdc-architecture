...
This specification defines **CI CD** as part of the Post Secondary Digital
...
- The CI CD capability SHALL provide a portable developer platform with consistent APIs, SDKs, builds, registries, templates, and environments.
