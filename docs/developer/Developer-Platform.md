...
This specification defines **Developer Platform** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Developer Platform.
...
- The Developer Platform capability SHALL provide a portable developer platform with consistent APIs, SDKs, builds, registries, templates, and environments.
