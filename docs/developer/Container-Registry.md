...
This specification defines **Container Registry** as part of the Post Secondary Digital
...
- The Container Registry capability SHALL provide a portable developer platform with consistent APIs, SDKs, builds, registries, templates, and environments.
