...
This specification defines **CLI Specification** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for CLI Specification.
...
- The CLI Specification capability SHALL provide a portable developer platform with consistent APIs, SDKs, builds, registries, templates, and environments.
