...
This specification defines **Tool Registry** as part of the Post Secondary Digital
...
- The Tool Registry capability SHALL provide provider-neutral AI access, policy enforcement, model routing, tool safety, evaluation, and accountable agent execution.
