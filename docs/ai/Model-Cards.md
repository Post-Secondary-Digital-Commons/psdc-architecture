...
This specification defines **Model Cards** as part of the Post Secondary Digital
...
- The Model Cards capability SHALL provide provider-neutral AI access, policy enforcement, model routing, tool safety, evaluation, and accountable agent execution.
