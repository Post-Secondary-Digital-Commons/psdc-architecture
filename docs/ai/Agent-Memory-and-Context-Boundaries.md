...
This specification defines **Agent Memory and Context Boundaries** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Agent Memory and Context Boundaries.
...
- The Agent Memory and Context Boundaries capability SHALL provide provider-neutral AI access, policy enforcement, model routing, tool safety, evaluation, and accountable agent execution.
