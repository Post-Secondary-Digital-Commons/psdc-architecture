...
This specification defines **Model Router** as part of the Post Secondary Digital
...
- The Model Router capability SHALL provide provider-neutral AI access, policy enforcement, model routing, tool safety, evaluation, and accountable agent execution.
