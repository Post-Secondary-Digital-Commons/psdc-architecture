...
This specification defines **AI Gateway** as part of the Post Secondary Digital
...
- The AI Gateway capability SHALL provide provider-neutral AI access, policy enforcement, model routing, tool safety, evaluation, and accountable agent execution.
