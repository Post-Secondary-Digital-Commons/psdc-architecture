...
This specification defines **Inference Scheduling** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Inference Scheduling.
...
- The Inference Scheduling capability SHALL provide provider-neutral AI access, policy enforcement, model routing, tool safety, evaluation, and accountable agent execution.
