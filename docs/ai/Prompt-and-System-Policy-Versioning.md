...
This specification defines **Prompt and System Policy Versioning** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Prompt and System Policy Versioning.
...
- The Prompt and System Policy Versioning capability SHALL provide provider-neutral AI access, policy enforcement, model routing, tool safety, evaluation, and accountable agent execution.
