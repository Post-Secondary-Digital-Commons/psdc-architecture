...
This specification defines **Public vs Private Federation** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Public vs Private Federation.
...
- The Public vs Private Federation capability SHALL provide institution-sovereign social federation with shared interoperability, moderation, safety, and portability policy.
