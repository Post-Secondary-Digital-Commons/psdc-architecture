...
This specification defines **Upstream Fork and Patch Policy** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Upstream Fork and Patch Policy.
...
- The Upstream Fork and Patch Policy capability SHALL provide institution-sovereign social federation with shared interoperability, moderation, safety, and portability policy.
