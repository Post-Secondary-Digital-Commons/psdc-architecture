...
This specification defines **SSO Integration** as part of the Post Secondary Digital
...
- The SSO Integration capability SHALL provide institution-sovereign social federation with shared interoperability, moderation, safety, and portability policy.
