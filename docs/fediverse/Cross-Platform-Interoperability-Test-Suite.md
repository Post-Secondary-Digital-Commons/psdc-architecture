...
This specification defines **Cross Platform Interoperability Test Suite** as part of the Post Secondary Digital
Commons. Its required outcome is institution-sovereign social federation with shared interoperability, moderation, safety, and portability policy. An implementation conforms
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Cross Platform Interoperability Test Suite.
...
- The Cross Platform Interoperability Test Suite capability SHALL provide institution-sovereign social federation with shared interoperability, moderation, safety, and portability policy.
