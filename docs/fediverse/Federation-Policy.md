...
This specification defines **Federation Policy** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Federation Policy.
...
- The Federation Policy capability SHALL provide institution-sovereign social federation with shared interoperability, moderation, safety, and portability policy.
