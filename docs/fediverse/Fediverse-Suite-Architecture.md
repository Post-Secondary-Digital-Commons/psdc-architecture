...
This specification defines **Fediverse Suite Architecture** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Fediverse Suite Architecture.
...
- The Fediverse Suite Architecture capability SHALL provide institution-sovereign social federation with shared interoperability, moderation, safety, and portability policy.
