...
This specification defines **Shared Media Integration** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Shared Media Integration.
...
- The Shared Media Integration capability SHALL provide institution-sovereign social federation with shared interoperability, moderation, safety, and portability policy.
