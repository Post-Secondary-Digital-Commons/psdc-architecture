...
This specification defines **ActivityStreams Profile** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for ActivityStreams Profile.
...
- The ActivityStreams Profile capability SHALL provide institution-sovereign social federation with shared interoperability, moderation, safety, and portability policy.
