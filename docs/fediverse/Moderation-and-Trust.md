...
This specification defines **Moderation and Trust** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Moderation and Trust.
...
- The Moderation and Trust capability SHALL provide institution-sovereign social federation with shared interoperability, moderation, safety, and portability policy.
