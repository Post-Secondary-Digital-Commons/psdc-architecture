...
This specification defines **Federation Abuse Prevention** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Federation Abuse Prevention.
...
- The Federation Abuse Prevention capability SHALL provide institution-sovereign social federation with shared interoperability, moderation, safety, and portability policy.
