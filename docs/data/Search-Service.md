...
This specification defines **Search Service** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Search Service.
...
- The Search Service capability SHALL provide managed relational, cache, search, vector, lake, catalog, migration, backup, and recovery capabilities.
