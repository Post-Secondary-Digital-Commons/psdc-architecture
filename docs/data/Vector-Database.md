...
This specification defines **Vector Database** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Vector Database.
...
- The Vector Database capability SHALL provide managed relational, cache, search, vector, lake, catalog, migration, backup, and recovery capabilities.
