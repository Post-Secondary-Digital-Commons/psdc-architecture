...
This specification defines **Backup and PITR** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Backup and PITR.
...
- The Backup and PITR capability SHALL provide managed relational, cache, search, vector, lake, catalog, migration, backup, and recovery capabilities.
