...
This specification defines **Managed MySQL** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Managed MySQL.
...
- The Managed MySQL capability SHALL provide managed relational, cache, search, vector, lake, catalog, migration, backup, and recovery capabilities.
