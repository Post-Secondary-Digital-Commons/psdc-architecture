# Commons Compute Fabric Economics
...
This specification defines **Commons Compute Fabric Economics** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Commons Compute Fabric Economics.
...
- The Commons Compute Fabric Economics capability SHALL provide transparent capacity, cost, funding, quota, power, cooling, storage, network, and sustainability decisions.
