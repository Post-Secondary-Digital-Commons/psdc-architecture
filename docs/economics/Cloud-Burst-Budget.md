...
This specification defines **Cloud Burst Budget** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Cloud Burst Budget.
...
- The Cloud Burst Budget capability SHALL provide transparent capacity, cost, funding, quota, power, cooling, storage, network, and sustainability decisions.
