...
This specification defines **Cloud vs OnPrem** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Cloud vs OnPrem.
...
- The Cloud vs OnPrem capability SHALL provide transparent capacity, cost, funding, quota, power, cooling, storage, network, and sustainability decisions.
