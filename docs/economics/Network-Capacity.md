...
This specification defines **Network Capacity** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Network Capacity.
...
- The Network Capacity capability SHALL provide transparent capacity, cost, funding, quota, power, cooling, storage, network, and sustainability decisions.
