...
This specification defines **Webhooks** as part of the Post Secondary Digital
...
- The Webhooks capability SHALL provide reliable composition of independently owned services through explicit synchronous, asynchronous, and batch boundaries.
