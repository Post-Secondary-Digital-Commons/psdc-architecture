...
> Domain: integration
> Owner: PSDC Integration Working Group; accountable maintainer RedjiJB until delegation
> Last reviewed: 2026-09-11

## Purpose and outcome

This specification defines **Distributed Transactions and Sagas** as part of the Post Secondary Digital
Commons. Its required outcome is reliable composition of independently owned services through explicit synchronous, asynchronous, and batch boundaries. An implementation conforms
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Distributed Transactions and Sagas.
...
- The Distributed Transactions and Sagas capability SHALL provide reliable composition of independently owned services through explicit synchronous, asynchronous, and batch boundaries.
...
- Required interoperability boundary: OpenAPI, AsyncAPI, CloudEvents, webhooks, idempotency keys, correlation identifiers, and schema registries.
...
- Governed information includes contract schemas, events, delivery state, reconciliation checkpoints, dead-letter records, and integration audit metadata.
...
- Domain controls SHALL include authenticated endpoints, scoped service identities, signature verification, replay protection, schema validation, and data minimization.
...
- Required lifecycle behaviour includes timeouts, retries with jitter, circuit breakers, dead-letter handling, replay, reconciliation, and consumer-lag monitoring.
...
- Adopted boundary and strategy: OpenAPI 3.1, AsyncAPI, CloudEvents, JSON Schema, and contract tests independent of vendor middleware.
