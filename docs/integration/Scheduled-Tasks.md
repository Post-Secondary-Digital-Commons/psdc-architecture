...
This specification defines **Scheduled Tasks** as part of the Post Secondary Digital
...
- The Scheduled Tasks capability SHALL provide reliable composition of independently owned services through explicit synchronous, asynchronous, and batch boundaries.
