...
This specification defines **Event Bus** as part of the Post Secondary Digital
...
- The Event Bus capability SHALL provide reliable composition of independently owned services through explicit synchronous, asynchronous, and batch boundaries.
