...
This specification defines **PubSub** as part of the Post Secondary Digital
...
- The PubSub capability SHALL provide reliable composition of independently owned services through explicit synchronous, asynchronous, and batch boundaries.
