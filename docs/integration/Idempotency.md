...
This specification defines **Idempotency** as part of the Post Secondary Digital
...
- The Idempotency capability SHALL provide reliable composition of independently owned services through explicit synchronous, asynchronous, and batch boundaries.
