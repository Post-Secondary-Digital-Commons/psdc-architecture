...
This specification defines **Subnet and Routing** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Subnet and Routing.
...
- The Subnet and Routing capability SHALL provide segmented, observable, policy-controlled campus and federation connectivity without provider lock-in.
