...
This specification defines **Load Balancing** as part of the Post Secondary Digital
...
- The Load Balancing capability SHALL provide segmented, observable, policy-controlled campus and federation connectivity without provider lock-in.
