...
This specification defines **DNS** as part of the Post Secondary Digital
...
- The DNS capability SHALL provide segmented, observable, policy-controlled campus and federation connectivity without provider lock-in.
