...
This specification defines **Campus Compute Network** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Campus Compute Network.
...
- The Campus Compute Network capability SHALL provide segmented, observable, policy-controlled campus and federation connectivity without provider lock-in.
