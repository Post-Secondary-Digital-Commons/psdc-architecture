...
This specification defines **VPN** as part of the Post Secondary Digital
...
- The VPN capability SHALL provide segmented, observable, policy-controlled campus and federation connectivity without provider lock-in.
