...
This specification defines **IP Address Management** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for IP Address Management.
...
- The IP Address Management capability SHALL provide segmented, observable, policy-controlled campus and federation connectivity without provider lock-in.
