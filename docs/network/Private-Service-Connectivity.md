...
This specification defines **Private Service Connectivity** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Private Service Connectivity.
...
- The Private Service Connectivity capability SHALL provide segmented, observable, policy-controlled campus and federation connectivity without provider lock-in.
