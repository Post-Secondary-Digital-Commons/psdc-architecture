...
This specification defines **Ingress and Egress** as part of the Post Secondary Digital
...
- The Ingress and Egress capability SHALL provide segmented, observable, policy-controlled campus and federation connectivity without provider lock-in.
