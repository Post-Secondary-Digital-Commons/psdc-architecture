...
This specification defines **GPU Fabric Networking** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for GPU Fabric Networking.
...
- The GPU Fabric Networking capability SHALL provide segmented, observable, policy-controlled campus and federation connectivity without provider lock-in.
