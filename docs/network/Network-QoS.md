...
This specification defines **Network QoS** as part of the Post Secondary Digital
...
- The Network QoS capability SHALL provide segmented, observable, policy-controlled campus and federation connectivity without provider lock-in.
