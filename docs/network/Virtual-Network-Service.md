...
This specification defines **Virtual Network Service** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Virtual Network Service.
...
- The Virtual Network Service capability SHALL provide segmented, observable, policy-controlled campus and federation connectivity without provider lock-in.
