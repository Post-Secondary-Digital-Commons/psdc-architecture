...
This specification defines **Federation Egress** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Federation Egress.
...
- The Federation Egress capability SHALL provide segmented, observable, policy-controlled campus and federation connectivity without provider lock-in.
