...
This specification defines **Event Discovery** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Event Discovery.
...
- The Event Discovery capability SHALL provide student-controlled planning, scheduling, navigation, clubs, events, wellbeing referrals, opportunities, and campus-service discovery.
