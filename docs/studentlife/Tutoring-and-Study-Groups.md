...
This specification defines **Tutoring and Study Groups** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Tutoring and Study Groups.
...
- The Tutoring and Study Groups capability SHALL provide student-controlled planning, scheduling, navigation, clubs, events, wellbeing referrals, opportunities, and campus-service discovery.
