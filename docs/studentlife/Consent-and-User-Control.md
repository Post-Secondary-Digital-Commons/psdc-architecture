...
This specification defines **Consent and User Control** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Consent and User Control.
...
- The Consent and User Control capability SHALL provide student-controlled planning, scheduling, navigation, clubs, events, wellbeing referrals, opportunities, and campus-service discovery.
