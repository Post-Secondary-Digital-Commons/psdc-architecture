...
This specification defines **Portfolio Agent** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Portfolio Agent.
...
- The Portfolio Agent capability SHALL provide student-controlled planning, scheduling, navigation, clubs, events, wellbeing referrals, opportunities, and campus-service discovery.
