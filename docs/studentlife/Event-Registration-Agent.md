...
This specification defines **Event Registration Agent** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Event Registration Agent.
...
- The Event Registration Agent capability SHALL provide student-controlled planning, scheduling, navigation, clubs, events, wellbeing referrals, opportunities, and campus-service discovery.
