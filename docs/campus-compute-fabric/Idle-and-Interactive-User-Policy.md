...
This specification defines **Idle and Interactive User Policy** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Idle and Interactive User Policy.
...
- The Idle and Interactive User Policy capability SHALL provide institution-controlled heterogeneous campus compute with explicit capability, trust, scheduling, and preemption contracts.
