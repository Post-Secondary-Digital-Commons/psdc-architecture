...
This specification defines **Distributed Inference Backend Interface** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Distributed Inference Backend Interface.
...
- The Distributed Inference Backend Interface capability SHALL provide institution-controlled heterogeneous campus compute with explicit capability, trust, scheduling, and preemption contracts.
