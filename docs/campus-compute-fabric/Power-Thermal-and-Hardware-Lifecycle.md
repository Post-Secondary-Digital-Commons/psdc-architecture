...
This specification defines **Power Thermal and Hardware Lifecycle** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Power Thermal and Hardware Lifecycle.
...
- The Power Thermal and Hardware Lifecycle capability SHALL provide institution-controlled heterogeneous campus compute with explicit capability, trust, scheduling, and preemption contracts.
