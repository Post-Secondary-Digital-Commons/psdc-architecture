...
This specification defines **Topology Discovery** as part of the Post Secondary Digital
...
- The Topology Discovery capability SHALL provide institution-controlled heterogeneous campus compute with explicit capability, trust, scheduling, and preemption contracts.
