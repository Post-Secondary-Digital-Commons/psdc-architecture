...
This specification defines **Node Enrollment and Attestation** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Node Enrollment and Attestation.
...
- The Node Enrollment and Attestation capability SHALL provide institution-controlled heterogeneous campus compute with explicit capability, trust, scheduling, and preemption contracts.
