...
This specification defines **HTCondor Interoperability** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for HTCondor Interoperability.
...
- The HTCondor Interoperability capability SHALL provide institution-controlled heterogeneous campus compute with explicit capability, trust, scheduling, and preemption contracts.
