...
This specification defines **vLLM Backend** as part of the Post Secondary Digital
...
- The vLLM Backend capability SHALL provide institution-controlled heterogeneous campus compute with explicit capability, trust, scheduling, and preemption contracts.
