...
This specification defines **Exo Backend** as part of the Post Secondary Digital
...
- The Exo Backend capability SHALL provide institution-controlled heterogeneous campus compute with explicit capability, trust, scheduling, and preemption contracts.
