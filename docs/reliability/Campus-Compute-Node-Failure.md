# Commons Compute Fabric Node Failure

> Status: Normative specification; implementation gated
> Domain: reliability
> Owner: PSDC Reliability Working Group; accountable maintainer RedjiJB until delegation
> Last reviewed: 2026-09-11

## Purpose and outcome

This specification defines **Commons Compute Fabric Node Failure** as part of the Post Secondary Digital
Commons. Its required outcome is declared service objectives, redundancy, backup, recovery, degradation, chaos validation, and dependency resilience. An implementation conforms
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Commons Compute Fabric Node Failure.
...
- The Commons Compute Fabric Node Failure capability SHALL provide declared service objectives, redundancy, backup, recovery, degradation, chaos validation, and dependency resilience.
...
- Required interoperability boundary: health and readiness, service-level indicators, backup and restore, failover, incident, and dependency-status contracts.
...
- Governed information includes SLIs, objectives, error budgets, backup catalogs, restore evidence, failure tests, dependency health, and incident history.
...
- Domain controls SHALL include encrypted and access-controlled backups, recovery authorization, immutable evidence, and prevention of fail-open security behaviour.
...
- Required lifecycle behaviour includes failure-domain separation, tested restore, controlled failover, graceful degradation, capacity margin, and recurring resilience exercises.
...
- Adopted boundary and strategy: OpenTelemetry signals, declarative recovery objectives, portable backup formats, and automated evidence collection.
