...
This specification defines **Disaster Recovery** as part of the Post Secondary Digital
...
- The Disaster Recovery capability SHALL provide declared service objectives, redundancy, backup, recovery, degradation, chaos validation, and dependency resilience.
