...
This specification defines **Chaos Testing** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Chaos Testing.
...
- The Chaos Testing capability SHALL provide declared service objectives, redundancy, backup, recovery, degradation, chaos validation, and dependency resilience.
