...
This specification defines **Failover** as part of the Post Secondary Digital
...
- The Failover capability SHALL provide declared service objectives, redundancy, backup, recovery, degradation, chaos validation, and dependency resilience.
