...
This specification defines **Database Failover** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Database Failover.
...
- The Database Failover capability SHALL provide declared service objectives, redundancy, backup, recovery, degradation, chaos validation, and dependency resilience.
