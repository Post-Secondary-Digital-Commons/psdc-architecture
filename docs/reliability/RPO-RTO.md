...
This specification defines **RPO RTO** as part of the Post Secondary Digital
...
- The RPO RTO capability SHALL provide declared service objectives, redundancy, backup, recovery, degradation, chaos validation, and dependency resilience.
