...
This specification defines **Dependency Outage Matrix** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Dependency Outage Matrix.
...
- The Dependency Outage Matrix capability SHALL provide declared service objectives, redundancy, backup, recovery, degradation, chaos validation, and dependency resilience.
