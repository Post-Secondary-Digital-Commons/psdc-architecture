...
This specification defines **Fediverse FEP Process** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Fediverse FEP Process.
...
- The Fediverse FEP Process capability SHALL provide license-compatible adoption, provenance, upstream collaboration, patch management, and sustainable replacement paths.
