...
This specification defines **Upstream First Policy** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Upstream First Policy.
...
- The Upstream First Policy capability SHALL provide license-compatible adoption, provenance, upstream collaboration, patch management, and sustainable replacement paths.
