...
This specification defines **Standards Contribution Strategy** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Standards Contribution Strategy.
...
- The Standards Contribution Strategy capability SHALL provide license-compatible adoption, provenance, upstream collaboration, patch management, and sustainable replacement paths.
