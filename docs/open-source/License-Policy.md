...
This specification defines **License Policy** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for License Policy.
...
- The License Policy capability SHALL provide license-compatible adoption, provenance, upstream collaboration, patch management, and sustainable replacement paths.
