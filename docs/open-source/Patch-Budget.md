...
This specification defines **Patch Budget** as part of the Post Secondary Digital
...
- The Patch Budget capability SHALL provide license-compatible adoption, provenance, upstream collaboration, patch management, and sustainable replacement paths.
