...
This specification defines **Disaster Recovery Exercises** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Disaster Recovery Exercises.
...
- The Disaster Recovery Exercises capability SHALL provide repeatable unit, integration, contract, end-to-end, performance, resilience, accessibility, security, and federation validation.
