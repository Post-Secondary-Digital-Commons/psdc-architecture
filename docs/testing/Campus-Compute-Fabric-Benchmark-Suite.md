# Commons Compute Fabric Benchmark Suite

> Status: Normative specification; implementation gated
> Domain: testing
> Owner: PSDC Testing Working Group; accountable maintainer RedjiJB until delegation
> Last reviewed: 2026-09-11

## Purpose and outcome

This specification defines **Commons Compute Fabric Benchmark Suite** as part of the Post Secondary Digital
Commons. Its required outcome is repeatable unit, integration, contract, end-to-end, performance, resilience, accessibility, security, and federation validation. An implementation conforms
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Commons Compute Fabric Benchmark Suite.
...
- The Commons Compute Fabric Benchmark Suite capability SHALL provide repeatable unit, integration, contract, end-to-end, performance, resilience, accessibility, security, and federation validation.
...
- Required interoperability boundary: test manifests, fixtures, contract suites, environment controls, result formats, coverage, evidence, and release gates.
...
- Governed information includes synthetic fixtures, anonymized test data, expected results, performance baselines, findings, coverage, and signed evidence artifacts.
...
- Domain controls SHALL include no production secrets or unapproved personal data, isolated untrusted execution, adversarial cases, dependency scanning, and finding protection.
...
- Required lifecycle behaviour includes hermetic execution where practical, deterministic seeds, retry classification, quarantine expiry, baseline review, and failure triage.
...
- Adopted boundary and strategy: language-native test frameworks, OpenAPI and AsyncAPI contract tests, WCAG testing, ActivityPub interoperability, and machine-readable results.
