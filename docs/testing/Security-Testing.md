...
This specification defines **Security Testing** as part of the Post Secondary Digital
...
- The Security Testing capability SHALL provide repeatable unit, integration, contract, end-to-end, performance, resilience, accessibility, security, and federation validation.
