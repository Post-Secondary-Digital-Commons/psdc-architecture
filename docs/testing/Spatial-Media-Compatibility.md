...
This specification defines **Spatial Media Compatibility** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Spatial Media Compatibility.
...
- The Spatial Media Compatibility capability SHALL provide repeatable unit, integration, contract, end-to-end, performance, resilience, accessibility, security, and federation validation.
