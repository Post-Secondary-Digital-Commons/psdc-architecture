...
This specification defines **Load Testing** as part of the Post Secondary Digital
...
- The Load Testing capability SHALL provide repeatable unit, integration, contract, end-to-end, performance, resilience, accessibility, security, and federation validation.
