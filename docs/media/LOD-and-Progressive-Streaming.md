...
This specification defines **LOD and Progressive Streaming** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for LOD and Progressive Streaming.
...
- The LOD and Progressive Streaming capability SHALL provide portable image, video, audio, 3D, spatial, streaming, transcoding, metadata, and rights workflows.
