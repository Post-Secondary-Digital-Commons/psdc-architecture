...
This specification defines **WriteFreely Spatial Embed** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for WriteFreely Spatial Embed.
...
- The WriteFreely Spatial Embed capability SHALL provide portable image, video, audio, 3D, spatial, streaming, transcoding, metadata, and rights workflows.
