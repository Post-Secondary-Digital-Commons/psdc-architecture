...
This specification defines **Thumbnail and Video Fallbacks** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Thumbnail and Video Fallbacks.
...
- The Thumbnail and Video Fallbacks capability SHALL provide portable image, video, audio, 3D, spatial, streaming, transcoding, metadata, and rights workflows.
