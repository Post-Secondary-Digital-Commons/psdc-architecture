...
This specification defines **Pixelfed Spatial Adapter** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Pixelfed Spatial Adapter.
...
- The Pixelfed Spatial Adapter capability SHALL provide portable image, video, audio, 3D, spatial, streaming, transcoding, metadata, and rights workflows.
