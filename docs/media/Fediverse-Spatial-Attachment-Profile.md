...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Fediverse Spatial Attachment Profile.
...
- The Fediverse Spatial Attachment Profile capability SHALL provide portable image, video, audio, 3D, spatial, streaming, transcoding, metadata, and rights workflows.
