...
This specification defines **PeerTube Spatial Player** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for PeerTube Spatial Player.
...
- The PeerTube Spatial Player capability SHALL provide portable image, video, audio, 3D, spatial, streaming, transcoding, metadata, and rights workflows.
