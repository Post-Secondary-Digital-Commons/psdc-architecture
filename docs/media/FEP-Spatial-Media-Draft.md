...
This specification defines **FEP Spatial Media Draft** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for FEP Spatial Media Draft.
...
- The FEP Spatial Media Draft capability SHALL provide portable image, video, audio, 3D, spatial, streaming, transcoding, metadata, and rights workflows.
