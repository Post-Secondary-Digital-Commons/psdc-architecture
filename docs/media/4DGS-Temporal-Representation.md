...
This specification defines **4DGS Temporal Representation** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for 4DGS Temporal Representation.
...
- The 4DGS Temporal Representation capability SHALL provide portable image, video, audio, 3D, spatial, streaming, transcoding, metadata, and rights workflows.
