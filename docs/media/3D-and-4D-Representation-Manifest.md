...
This specification defines **3D and 4D Representation Manifest** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for 3D and 4D Representation Manifest.
...
- The 3D and 4D Representation Manifest capability SHALL provide portable image, video, audio, 3D, spatial, streaming, transcoding, metadata, and rights workflows.
