...
This specification defines **Spatial Audio** as part of the Post Secondary Digital
...
- The Spatial Audio capability SHALL provide portable image, video, audio, 3D, spatial, streaming, transcoding, metadata, and rights workflows.
