...
This specification defines **Spatial Privacy and Bystander Protection** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Spatial Privacy and Bystander Protection.
...
- The Spatial Privacy and Bystander Protection capability SHALL provide portable image, video, audio, 3D, spatial, streaming, transcoding, metadata, and rights workflows.
...
- Required interoperability boundary: upload, resumable transfer, job, derivative, manifest, metadata, rights, delivery, and lifecycle contracts.
...
- Governed information includes source assets, immutable hashes, derivatives, manifests, spatial metadata, rights, provenance, moderation state, and retention records.
...
- Domain controls SHALL include malware scanning, content-type validation, signed access, rights enforcement, moderation, provenance, and protected-metadata controls.
...
- Required lifecycle behaviour includes resumable ingest, deterministic derivatives, queue backpressure, cache invalidation, lifecycle deletion, and failed-job recovery.
...
- Adopted boundary and strategy: S3-compatible objects, OCI where suitable, HLS or DASH, WebRTC, IIIF where suitable, glTF, OpenUSD, and portable metadata.
