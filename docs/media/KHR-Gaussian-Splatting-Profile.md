...
This specification defines **KHR Gaussian Splatting Profile** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for KHR Gaussian Splatting Profile.
...
- The KHR Gaussian Splatting Profile capability SHALL provide portable image, video, audio, 3D, spatial, streaming, transcoding, metadata, and rights workflows.
