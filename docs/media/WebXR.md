...
This specification defines **WebXR** as part of the Post Secondary Digital
...
- The WebXR capability SHALL provide portable image, video, audio, 3D, spatial, streaming, transcoding, metadata, and rights workflows.
