...
This specification defines **ActivityStreams Spatial Extension** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for ActivityStreams Spatial Extension.
...
- The ActivityStreams Spatial Extension capability SHALL provide portable image, video, audio, 3D, spatial, streaming, transcoding, metadata, and rights workflows.
