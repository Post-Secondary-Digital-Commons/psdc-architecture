...
This specification defines **PKI** as part of the Post Secondary Digital
...
- The PKI capability SHALL provide defence in depth across identity, software supply chain, workloads, data, networks, clients, federation, and incident response.
