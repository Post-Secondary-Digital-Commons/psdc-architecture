...
This specification defines **Incident Response** as part of the Post Secondary Digital
...
- The Incident Response capability SHALL provide defence in depth across identity, software supply chain, workloads, data, networks, clients, federation, and incident response.
