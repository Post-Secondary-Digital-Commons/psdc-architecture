...
This specification defines **SBOM** as part of the Post Secondary Digital
...
- The SBOM capability SHALL provide defence in depth across identity, software supply chain, workloads, data, networks, clients, federation, and incident response.
