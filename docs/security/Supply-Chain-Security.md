...
This specification defines **Supply Chain Security** as part of the Post Secondary Digital
...
- The Supply Chain Security capability SHALL provide defence in depth across identity, software supply chain, workloads, data, networks, clients, federation, and incident response.
