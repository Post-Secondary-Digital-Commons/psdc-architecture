...
This specification defines **Security Architecture** as part of the Post Secondary Digital
...
- The Security Architecture capability SHALL provide defence in depth across identity, software supply chain, workloads, data, networks, clients, federation, and incident response.
