...
This specification defines **Network Segmentation** as part of the Post Secondary Digital
...
- The Network Segmentation capability SHALL provide defence in depth across identity, software supply chain, workloads, data, networks, clients, federation, and incident response.
