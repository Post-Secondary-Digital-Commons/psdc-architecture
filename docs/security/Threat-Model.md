...
This specification defines **Threat Model** as part of the Post Secondary Digital
...
- The Threat Model capability SHALL provide defence in depth across identity, software supply chain, workloads, data, networks, clients, federation, and incident response.
