...
This specification defines **01 Platform Scope** as part of the Post Secondary Digital
...
- The 01 Platform Scope capability SHALL provide a durable institution-neutral direction, vocabulary, principles, boundaries, and success model for the Commons.
