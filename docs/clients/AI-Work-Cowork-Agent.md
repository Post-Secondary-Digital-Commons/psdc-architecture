...
This specification defines **AI Work Cowork Agent** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for AI Work Cowork Agent.
...
- The AI Work Cowork Agent capability SHALL provide accessible, institution-branded web, desktop, mobile, and command-line experiences over shared platform contracts.
