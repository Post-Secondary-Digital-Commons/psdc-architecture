...
This specification defines **Android** as part of the Post Secondary Digital
...
- The Android capability SHALL provide accessible, institution-branded web, desktop, mobile, and command-line experiences over shared platform contracts.
