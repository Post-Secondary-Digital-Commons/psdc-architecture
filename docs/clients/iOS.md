...
This specification defines **iOS** as part of the Post Secondary Digital
...
- The iOS capability SHALL provide accessible, institution-branded web, desktop, mobile, and command-line experiences over shared platform contracts.
