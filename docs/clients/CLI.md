...
This specification defines **CLI** as part of the Post Secondary Digital
...
- The CLI capability SHALL provide accessible, institution-branded web, desktop, mobile, and command-line experiences over shared platform contracts.
