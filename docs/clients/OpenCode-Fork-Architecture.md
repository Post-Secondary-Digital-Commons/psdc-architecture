...
This specification defines **OpenCode Fork Architecture** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for OpenCode Fork Architecture.
...
- The OpenCode Fork Architecture capability SHALL provide accessible, institution-branded web, desktop, mobile, and command-line experiences over shared platform contracts.
