...
This specification defines **Web Architecture** as part of the Post Secondary Digital
...
- The Web Architecture capability SHALL provide accessible, institution-branded web, desktop, mobile, and command-line experiences over shared platform contracts.
