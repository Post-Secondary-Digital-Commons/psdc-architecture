...
This specification defines **Push Notifications** as part of the Post Secondary Digital
...
- The Push Notifications capability SHALL provide accessible, institution-branded web, desktop, mobile, and command-line experiences over shared platform contracts.
