...
This specification defines **Desktop Local Tool Sandbox** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Desktop Local Tool Sandbox.
...
- The Desktop Local Tool Sandbox capability SHALL provide accessible, institution-branded web, desktop, mobile, and command-line experiences over shared platform contracts.
