...
This specification defines **Desktop File Permissions** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Desktop File Permissions.
...
- The Desktop File Permissions capability SHALL provide accessible, institution-branded web, desktop, mobile, and command-line experiences over shared platform contracts.
