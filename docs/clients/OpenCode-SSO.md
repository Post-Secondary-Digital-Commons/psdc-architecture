...
This specification defines **OpenCode SSO** as part of the Post Secondary Digital
...
- The OpenCode SSO capability SHALL provide accessible, institution-branded web, desktop, mobile, and command-line experiences over shared platform contracts.
