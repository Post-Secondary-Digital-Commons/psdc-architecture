...
This specification defines **Accessibility** as part of the Post Secondary Digital
...
- The Accessibility capability SHALL provide accessible, institution-branded web, desktop, mobile, and command-line experiences over shared platform contracts.
