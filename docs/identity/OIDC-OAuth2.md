...
This specification defines **OIDC OAuth2** as part of the Post Secondary Digital
...
- The OIDC OAuth2 capability SHALL provide institution-authoritative authentication, federation, provisioning, authorization, sessions, service identity, and account lifecycle.
