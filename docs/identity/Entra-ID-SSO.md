...
This specification defines **Entra ID SSO** as part of the Post Secondary Digital
...
- The Entra ID SSO capability SHALL provide institution-authoritative authentication, federation, provisioning, authorization, sessions, service identity, and account lifecycle.
