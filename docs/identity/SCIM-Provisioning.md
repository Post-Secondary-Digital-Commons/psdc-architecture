...
This specification defines **SCIM Provisioning** as part of the Post Secondary Digital
...
- The SCIM Provisioning capability SHALL provide institution-authoritative authentication, federation, provisioning, authorization, sessions, service identity, and account lifecycle.
