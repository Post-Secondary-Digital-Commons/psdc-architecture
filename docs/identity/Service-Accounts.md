...
This specification defines **Service Accounts** as part of the Post Secondary Digital
...
- The Service Accounts capability SHALL provide institution-authoritative authentication, federation, provisioning, authorization, sessions, service identity, and account lifecycle.
