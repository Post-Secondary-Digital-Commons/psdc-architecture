...
This specification defines **Bare Metal** as part of the Post Secondary Digital
...
- The Bare Metal capability SHALL provide portable virtual-machine, container, batch, function, bare-metal, GPU, and managed-cluster services.
