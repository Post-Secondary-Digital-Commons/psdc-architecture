...
This specification defines **AC Compute Specification** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for AC Compute Specification.
...
- The AC Compute Specification capability SHALL provide portable virtual-machine, container, batch, function, bare-metal, GPU, and managed-cluster services.
