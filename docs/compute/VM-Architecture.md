...
This specification defines **VM Architecture** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for VM Architecture.
...
- The VM Architecture capability SHALL provide portable virtual-machine, container, batch, function, bare-metal, GPU, and managed-cluster services.
