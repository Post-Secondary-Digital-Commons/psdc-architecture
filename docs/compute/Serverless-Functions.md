...
This specification defines **Serverless Functions** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Serverless Functions.
...
- The Serverless Functions capability SHALL provide portable virtual-machine, container, batch, function, bare-metal, GPU, and managed-cluster services.
