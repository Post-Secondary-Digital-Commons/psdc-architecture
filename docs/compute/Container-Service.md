...
This specification defines **Container Service** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Container Service.
...
- The Container Service capability SHALL provide portable virtual-machine, container, batch, function, bare-metal, GPU, and managed-cluster services.
