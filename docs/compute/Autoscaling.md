...
This specification defines **Autoscaling** as part of the Post Secondary Digital
...
- The Autoscaling capability SHALL provide portable virtual-machine, container, batch, function, bare-metal, GPU, and managed-cluster services.
