...
This specification defines **Preemption and Priority** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Preemption and Priority.
...
- The Preemption and Priority capability SHALL provide portable virtual-machine, container, batch, function, bare-metal, GPU, and managed-cluster services.
