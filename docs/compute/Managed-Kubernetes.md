...
This specification defines **Managed Kubernetes** as part of the Post Secondary Digital
...
- The Managed Kubernetes capability SHALL provide portable virtual-machine, container, batch, function, bare-metal, GPU, and managed-cluster services.
