...
> Domain: compute
> Owner: PSDC Compute Working Group; accountable maintainer RedjiJB until delegation
> Last reviewed: 2026-09-11

## Purpose and outcome

This specification defines **GPU and Accelerator Service** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for GPU and Accelerator Service.
...
- The GPU and Accelerator Service capability SHALL provide portable virtual-machine, container, batch, function, bare-metal, GPU, and managed-cluster services.
