...
> Domain: storage
> Owner: PSDC Storage Working Group; accountable maintainer RedjiJB until delegation
> Last reviewed: 2026-09-11

## Purpose and outcome

This specification defines **S3 Compatible Object Storage** as part of the Post Secondary Digital
Commons. Its required outcome is portable object, block, file, archival, replication, encryption, lifecycle, quota, and backup services. An implementation conforms
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for S3 Compatible Object Storage.
...
- The S3 Compatible Object Storage capability SHALL provide portable object, block, file, archival, replication, encryption, lifecycle, quota, and backup services.
...
- Required interoperability boundary: S3-compatible object access, volume and file claims, lifecycle, quota, snapshot, replication, export, and deletion contracts.
...
- Governed information includes objects, blocks, files, metadata, hashes, snapshots, replicas, encryption metadata, retention state, and usage records.
...
- Domain controls SHALL include encryption, tenant isolation, signed access, key separation, immutable retention where required, verified deletion, and ransomware-resistant backups.
...
- Required lifecycle behaviour includes capacity thresholds, integrity scrubbing, replication repair, snapshot and restore, lifecycle transition, quota enforcement, and disaster recovery.
...
- Adopted boundary and strategy: S3-compatible APIs, CSI where applicable, content-addressed integrity, open archival formats, and portable export.
