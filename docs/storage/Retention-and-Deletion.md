...
This specification defines **Retention and Deletion** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Retention and Deletion.
...
- The Retention and Deletion capability SHALL provide portable object, block, file, archival, replication, encryption, lifecycle, quota, and backup services.
