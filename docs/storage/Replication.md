...
This specification defines **Replication** as part of the Post Secondary Digital
...
- The Replication capability SHALL provide portable object, block, file, archival, replication, encryption, lifecycle, quota, and backup services.
