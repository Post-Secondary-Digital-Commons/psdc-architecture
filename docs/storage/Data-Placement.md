...
This specification defines **Data Placement** as part of the Post Secondary Digital
...
- The Data Placement capability SHALL provide portable object, block, file, archival, replication, encryption, lifecycle, quota, and backup services.
