...
This specification defines **Building and Edge Caches** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Building and Edge Caches.
...
- The Building and Edge Caches capability SHALL provide portable object, block, file, archival, replication, encryption, lifecycle, quota, and backup services.
