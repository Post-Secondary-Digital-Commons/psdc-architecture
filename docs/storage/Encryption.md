...
This specification defines **Encryption** as part of the Post Secondary Digital
...
- The Encryption capability SHALL provide portable object, block, file, archival, replication, encryption, lifecycle, quota, and backup services.
