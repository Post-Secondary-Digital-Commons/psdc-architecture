...
This specification defines **Block Storage** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Block Storage.
...
- The Block Storage capability SHALL provide portable object, block, file, archival, replication, encryption, lifecycle, quota, and backup services.
