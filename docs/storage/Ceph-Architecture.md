...
This specification defines **Ceph Architecture** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Ceph Architecture.
...
- The Ceph Architecture capability SHALL provide portable object, block, file, archival, replication, encryption, lifecycle, quota, and backup services.
