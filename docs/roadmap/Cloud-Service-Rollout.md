...
This specification defines **Cloud Service Rollout** as part of the Post Secondary Digital
...
- The Cloud Service Rollout capability SHALL provide dependency-ordered delivery with explicit outcomes, entry and exit criteria, risks, owners, and evidence.
