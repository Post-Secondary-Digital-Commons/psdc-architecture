...
This specification defines **Agent Approval UX** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Agent Approval UX.
...
- The Agent Approval UX capability SHALL provide coherent student, faculty, staff, administrator, researcher, developer, and community experiences with measurable outcomes.
