...
This specification defines **Service UX Consistency** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Service UX Consistency.
...
- The Service UX Consistency capability SHALL provide coherent student, faculty, staff, administrator, researcher, developer, and community experiences with measurable outcomes.
