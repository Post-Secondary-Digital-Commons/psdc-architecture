...
This specification defines **Mobile Design System** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Mobile Design System.
...
- The Mobile Design System capability SHALL provide coherent student, faculty, staff, administrator, researcher, developer, and community experiences with measurable outcomes.
