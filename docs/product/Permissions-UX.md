...
This specification defines **Permissions UX** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Permissions UX.
...
- The Permissions UX capability SHALL provide coherent student, faculty, staff, administrator, researcher, developer, and community experiences with measurable outcomes.
