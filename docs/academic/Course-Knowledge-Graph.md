...
This specification defines **Course Knowledge Graph** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Course Knowledge Graph.
...
- The Course Knowledge Graph capability SHALL provide portable academic workflows while the institutional SIS and LMS remain authoritative.
