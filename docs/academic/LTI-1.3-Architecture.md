...
This specification defines **LTI 1.3 Architecture** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for LTI 1.3 Architecture.
...
- The LTI 1.3 Architecture capability SHALL provide portable academic workflows while the institutional SIS and LMS remain authoritative.
