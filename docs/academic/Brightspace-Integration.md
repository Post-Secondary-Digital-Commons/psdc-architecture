...
This specification defines **Brightspace Integration** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Brightspace Integration.
...
- The Brightspace Integration capability SHALL provide portable academic workflows while the institutional SIS and LMS remain authoritative.
