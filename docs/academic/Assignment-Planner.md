...
This specification defines **Assignment Planner** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Assignment Planner.
...
- The Assignment Planner capability SHALL provide portable academic workflows while the institutional SIS and LMS remain authoritative.
