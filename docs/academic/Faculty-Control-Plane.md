...
This specification defines **Faculty Control Plane** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Faculty Control Plane.
...
- The Faculty Control Plane capability SHALL provide portable academic workflows while the institutional SIS and LMS remain authoritative.
