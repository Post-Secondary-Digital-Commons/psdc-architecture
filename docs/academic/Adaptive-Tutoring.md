...
This specification defines **Adaptive Tutoring** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Adaptive Tutoring.
...
- The Adaptive Tutoring capability SHALL provide portable academic workflows while the institutional SIS and LMS remain authoritative.
