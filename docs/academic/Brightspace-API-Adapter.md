...
This specification defines **Brightspace API Adapter** as part of the Post Secondary Digital
Commons. Its required outcome is portable academic workflows while the institutional SIS and LMS remain authoritative. An implementation conforms
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Brightspace API Adapter.
...
- The Brightspace API Adapter capability SHALL provide portable academic workflows while the institutional SIS and LMS remain authoritative.
...
- Required interoperability boundary: LTI 1.3, OneRoster where applicable, Caliper-compatible events, and institution-approved LMS adapter APIs.
...
- Governed information includes course, enrolment, assessment, content, mastery, and learner-support records classified as institutional academic data.
...
- Domain controls SHALL include faculty control, learner consent, academic-integrity policy, purpose limitation, and prohibition of unapproved grade mutation.
...
- Required lifecycle behaviour includes term rollover, course archival, roster reconciliation, instructor override, and read-only degradation when the LMS is unavailable.
...
- Adopted boundary and strategy: 1EdTech standards and supported institutional APIs; screen scraping is prohibited.
