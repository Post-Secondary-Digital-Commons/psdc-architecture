...
This specification defines **Cross Course Synthesis** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Cross Course Synthesis.
...
- The Cross Course Synthesis capability SHALL provide portable academic workflows while the institutional SIS and LMS remain authoritative.
