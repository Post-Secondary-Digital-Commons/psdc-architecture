...
This specification defines **Support Model** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Support Model.
...
- The Support Model capability SHALL provide thin institution overlays that retain local authority while conforming to portable Commons contracts.
