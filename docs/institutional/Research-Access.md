...
This specification defines **Research Access** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Research Access.
...
- The Research Access capability SHALL provide thin institution overlays that retain local authority while conforming to portable Commons contracts.
