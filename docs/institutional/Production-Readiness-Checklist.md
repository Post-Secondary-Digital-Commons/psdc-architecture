...
> Owner: PSDC Institutional Working Group; accountable maintainer RedjiJB until delegation
> Last reviewed: 2026-09-11

## Purpose and outcome

This specification defines **Production Readiness Checklist** as part of the Post Secondary Digital
Commons. Its required outcome is thin institution overlays that retain local authority while conforming to portable Commons contracts. An implementation conforms
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Production Readiness Checklist.
...
- The Production Readiness Checklist capability SHALL provide thin institution overlays that retain local authority while conforming to portable Commons contracts.
...
- Required interoperability boundary: signed institution manifests, branding packages, identity adapters, policy overlays, deployment values, and federation metadata.
...
- Governed information includes institution-owned configuration, approvals, domains, issuer identifiers, residency rules, contacts, and local service mappings.
...
- Domain controls SHALL include local legal authority, signature verification, configuration provenance, stricter-policy precedence, and isolation between institutions.
...
- Required lifecycle behaviour includes independent deployment, upstream synchronization, compatibility verification, local incident control, and standalone operation.
...
- Adopted boundary and strategy: Commons contracts with institution-owned adapters; institution forks SHALL remain thin and upstream-compatible.
...
- institutional identity, policy, data, and infrastructure decisions require College ownership and approval.
