...
This specification defines **Student Developer Access** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Student Developer Access.
...
- The Student Developer Access capability SHALL provide thin institution overlays that retain local authority while conforming to portable Commons contracts.
