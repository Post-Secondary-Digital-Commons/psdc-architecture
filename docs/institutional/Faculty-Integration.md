...
This specification defines **Faculty Integration** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Faculty Integration.
...
- The Faculty Integration capability SHALL provide thin institution overlays that retain local authority while conforming to portable Commons contracts.
