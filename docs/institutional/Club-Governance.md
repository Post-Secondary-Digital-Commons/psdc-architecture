...
This specification defines **Club Governance** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Club Governance.
...
- The Club Governance capability SHALL provide thin institution overlays that retain local authority while conforming to portable Commons contracts.
