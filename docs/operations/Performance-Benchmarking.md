...
This specification defines **Performance Benchmarking** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Performance Benchmarking.
...
- The Performance Benchmarking capability SHALL provide observable, supportable services with clear ownership, service levels, incident response, maintenance, and capacity practice.
