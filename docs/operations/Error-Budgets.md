...
This specification defines **Error Budgets** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Error Budgets.
...
- The Error Budgets capability SHALL provide observable, supportable services with clear ownership, service levels, incident response, maintenance, and capacity practice.
