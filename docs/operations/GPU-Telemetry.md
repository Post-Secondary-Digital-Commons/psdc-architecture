...
This specification defines **GPU Telemetry** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for GPU Telemetry.
...
- The GPU Telemetry capability SHALL provide observable, supportable services with clear ownership, service levels, incident response, maintenance, and capacity practice.
