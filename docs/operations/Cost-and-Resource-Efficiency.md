...
> Domain: operations
> Owner: PSDC Operations Working Group; accountable maintainer RedjiJB until delegation
> Last reviewed: 2026-09-11

## Purpose and outcome

This specification defines **Cost and Resource Efficiency** as part of the Post Secondary Digital
Commons. Its required outcome is observable, supportable services with clear ownership, service levels, incident response, maintenance, and capacity practice. An implementation conforms
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Cost and Resource Efficiency.
...
- The Cost and Resource Efficiency capability SHALL provide observable, supportable services with clear ownership, service levels, incident response, maintenance, and capacity practice.
...
- Required interoperability boundary: service catalog records, health endpoints, telemetry, alerts, incident records, maintenance notices, and status communication.
...
- Governed information includes metrics, logs, traces, alerts, incidents, changes, capacity, service levels, and operational ownership metadata.
...
- Domain controls SHALL include restricted operational access, audited break-glass use, log privacy, alert integrity, secret rotation, and incident evidence preservation.
...
- Required lifecycle behaviour includes on-call ownership, severity classification, incident command, change windows, maintenance, capacity review, and post-incident learning.
...
- Adopted boundary and strategy: OpenTelemetry, Prometheus-compatible metrics, structured logs, open alert interfaces, and repository-controlled runbooks.
