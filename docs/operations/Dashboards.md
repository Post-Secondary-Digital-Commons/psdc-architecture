...
This specification defines **Dashboards** as part of the Post Secondary Digital
...
- The Dashboards capability SHALL provide observable, supportable services with clear ownership, service levels, incident response, maintenance, and capacity practice.
