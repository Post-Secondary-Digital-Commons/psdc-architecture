...
This specification defines **Security Incident** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Security Incident.
...
- The Security Incident capability SHALL provide safe, repeatable diagnosis, containment, recovery, communication, and verification for operational events.
