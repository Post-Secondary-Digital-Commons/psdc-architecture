...
This specification defines **AI Inference Degradation** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for AI Inference Degradation.
...
- The AI Inference Degradation capability SHALL provide safe, repeatable diagnosis, containment, recovery, communication, and verification for operational events.
