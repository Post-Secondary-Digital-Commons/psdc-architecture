...
This specification defines **Identity Outage** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Identity Outage.
...
- The Identity Outage capability SHALL provide safe, repeatable diagnosis, containment, recovery, communication, and verification for operational events.
