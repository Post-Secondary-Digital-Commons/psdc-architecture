# Commons Compute Fabric Worker Incident
...
This specification defines **Commons Compute Fabric Worker Incident** as part of the Post Secondary Digital
Commons. Its required outcome is safe, repeatable diagnosis, containment, recovery, communication, and verification for operational events. An implementation conforms
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Commons Compute Fabric Worker Incident.
...
- The Commons Compute Fabric Worker Incident capability SHALL provide safe, repeatable diagnosis, containment, recovery, communication, and verification for operational events.
...
- Required interoperability boundary: alerts, service ownership, escalation, commands, evidence capture, status communication, and post-incident records.
...
- Governed information includes symptoms, timestamps, affected scope, commands, results, decisions, communications, recovery evidence, and follow-up actions.
...
- Domain controls SHALL include least-privilege procedures, redacted output, dual control for destructive recovery, evidence preservation, and break-glass audit.
...
- Required lifecycle behaviour includes entry criteria, immediate safety checks, diagnosis, containment, recovery, verification, rollback, escalation, and closure.
...
- Adopted boundary and strategy: executable or testable procedures, explicit expected results, safe failure behaviour, and scheduled rehearsal.
