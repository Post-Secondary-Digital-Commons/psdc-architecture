...
This specification defines **Cloud Provider Failover** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Cloud Provider Failover.
...
- The Cloud Provider Failover capability SHALL provide safe, repeatable diagnosis, containment, recovery, communication, and verification for operational events.
