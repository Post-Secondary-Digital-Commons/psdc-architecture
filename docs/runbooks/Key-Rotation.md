...
This specification defines **Key Rotation** as part of the Post Secondary Digital
...
- The Key Rotation capability SHALL provide safe, repeatable diagnosis, containment, recovery, communication, and verification for operational events.
