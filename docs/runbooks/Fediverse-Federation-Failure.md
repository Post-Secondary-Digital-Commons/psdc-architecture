...
This specification defines **Fediverse Federation Failure** as part of the Post Secondary Digital
...
- **In scope:** behaviour, interfaces, dependencies, data, security, deployment
  ...
  requirements for Fediverse Federation Failure.
...
- The Fediverse Federation Failure capability SHALL provide safe, repeatable diagnosis, containment, recovery, communication, and verification for operational events.
