...
This specification defines **Service Discovery** as part of the Post Secondary Digital
...
- The Service Discovery capability SHALL provide coherent system boundaries, portable contracts, explicit trust zones, and institution-first federation.
