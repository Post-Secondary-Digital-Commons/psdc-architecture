...
This specification defines **Event Driven Architecture** as part of the Post Secondary Digital
...
- The Event Driven Architecture capability SHALL provide coherent system boundaries, portable contracts, explicit trust zones, and institution-first federation.
