...
This specification defines **High Availability** as part of the Post Secondary Digital
...
- The High Availability capability SHALL provide coherent system boundaries, portable contracts, explicit trust zones, and institution-first federation.
